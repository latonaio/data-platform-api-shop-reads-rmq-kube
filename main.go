...
import (
	dpfm_api_caller "data-platform-api-shop-reads-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-shop-reads-rmq-kube/config"
	"encoding/json"
	"fmt"
	"time"
...
func getAccepter(input *dpfm_api_input_reader.SDC) []string {
	...
	if accepter[0] == "All" {
		accepter = []string{
			...
			"Partner", "Partners",
			"Address", "Addresses",
			"AddressesByLocalRegion", "AddressesByLocalSubRegion",
		}
	}
	return accepter
}
